  ...
  private getSortedData(data: User[]) {
    ...
    return data.sort((a, b) => {
      ...
      switch (this.sort.active) {
        case 'name': return compare(a.firstName.toLowerCase(), b.firstName.toLowerCase(), isAsc);
        case 'lastName': return compare(a.lastName.toLowerCase(), b.lastName.toLowerCase(), isAsc);
